import logging
from DataPreprocessor.DataIO import DataIO
from DataPreprocessor.DataTransformer import DataTransformer
...
class DataPreprocessor:
    ...
    def load_data(self, filepath, numeric_cols=None, auto_convert_numeric=False, auto_convert_threshold=0.8):
        """
        Nạp dữ liệu và chuẩn hóa ban đầu.
    ...
    def clean_negative_values(self):
        ...
        Thay thế tất cả giá trị âm trong các cột số bằng giá trị tuyệt đối.
