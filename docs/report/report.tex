...
Quan sát Hình~\ref{fig:compare_models}, có thể thấy các mô hình phát triển từ \textit{linear regression} đều cho giá trị $R^2$ gần như tương đương nhau, cùng đạt khoảng \textbf{0.9972}. 
Sự sai khác ở 3 metrics còn lại (MAE, MSE, RMSE) là tương đối nhỏ và không mang ý nghĩa thực tiễn quá lớn trong bối cảnh bài toán, do đó có thể bỏ qua.

Dựa trên nhận định này, nhóm quyết định lựa chọn mô hình \textbf{Lasso} làm mô hình chính để phân tích sâu hơn.

\subsection{Phân tích đặc trưng quan trọng với mô hình Lasso}

Sau khi lựa chọn mô hình Lasso và tối ưu siêu tham số, nhóm tiến hành trích xuất trọng số của các đặc trưng để xác định mức độ quan trọng tương đối của từng biến đầu vào. 
...
Từ Hình~\ref{fig:lasso_importance}, cả 6 mô hình đều đồng thuận rằng \textbf{Total Fat (g)} và \textbf{Carbs (g)} là hai đặc trưng quan trọng nhất ảnh hưởng đến lượng Calories của món ăn nhanh.
